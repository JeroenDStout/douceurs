...
set(cmake_bin_dir     ${CMAKE_BINARY_DIR})
...
macro(init_directory name)
  ...
  string(REGEX REPLACE "src*" "assets"  dir_assets_rel  ${dir_src_rel})
  ...
  set(abs_can_assets  ${cmake_root_dir}/${dir_assets_rel})
  set(abs_gen_assets  ${CMAKE_BINARY_DIR}/gen/${dir_assets_rel})
  ...
  # message(STATUS "Canononical Assets  : ./${abs_can_assets}")
  ...
  # message(STATUS "Generated Assets    : ./${abs_gen_assets}")
endmacro()
...
macro(internal_add_project_source mode source)
  ...
  elseif ("asset" IN_LIST mode_list)
    set(path_name "${path_name}_assets")
  else()
...
macro(internal_recursive_setup_project_source mode arg1 arg2)
  ...
  elseif (${arg1} STREQUAL "assets:")
    internal_recursive_setup_project_source_argc("asset" ${arg2} ${ARGN})
...
function(sources_get_canonprint_filepath in_path out_path)  
  ...
  elseif (${in_path} MATCHES "${abs_can_assets}*")
    STRING(REGEX REPLACE "^${abs_can_assets}/" "assets/-/" tmp_path ${in_path})
  ...
  elseif (${in_path} MATCHES "${abs_gen_assets}*")
    STRING(REGEX REPLACE "^${abs_gen_assets}/" "assets/-/" tmp_path "${in_path}*")
  elseif()
